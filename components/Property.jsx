...
const Property = ({property: {coverPhoto, price, rentFrequency, rooms, title, baths, area, agency, isVerified, externalID }})=>(
    <Link href={`/property/${externalID}`} passHref>
        <Flex flexWrap="wrap" w="450px" p="5" paddingTop="0" justifyContent="flex-start" cursor="pointer">
            <Box>
            ...
            <Box w="full">
                <Flex paddingTop="2" alignItems="center" justifyContent="space-between">
                    <Flex alignItems="center">
                        ...
                        <Text fontWeight="bold" fontSize="sm">KES{millify(price)}{rentFrequency && `/${rentFrequency}`}</Text>
                        <Box>
                    ...
                    <Text fontSize="sm">
                        {/* displays the title of the photo is all characters are less than 40, else, it trancates the first 40 characters. */}
